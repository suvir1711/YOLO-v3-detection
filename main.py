...
video = cv2.VideoCapture('/Users/suvirsingh/Movies/porsche.mp4')
...
network = cv2.dnn.readNetFromDarknet('/Users/suvirsingh/Downloads/yolov3.cfg','/Users/suvirsingh/Downloads/yolov3.weights')

# Getting only output layer names that we need from YOLO
ln = network.getLayerNames()
output_layers = [ln[i-1] for i in network.getUnconnectedOutLayers()]
...
while True:
    ...
    if len(results) > 0:
        for i in results.flatten():
            ...
            cv2.putText(frame, text_box_current, (x_min, y_min - 5),
                        cv2.FONT_HERSHEY_COMPLEX, 2.3, colour_box_current, 2)
    ...
    if writer is None:
        ...
        writer = cv2.VideoWriter('/Users/suvirsingh/Movies/porsche2.mp4', resultVideo, 30,
